...
const Footer = () => {
    return (
        <footer className={'border-t-[3px] border-[#E0E0E0] pt-[43px] flex gap-y-[30px] flex-col'}>
            <div className="logo w-full justify-center items-center flex">
            ...
            <div className={'content-footer px-[16px]'}>
                ...
                <div className={'relative'}>
                    ...
                    <button className={'btn absolute top-[26px] right-[8px] h-[43px] w-[110.9px] px-[0] py-[0] rounded-full'}>
                       <span className={'text-[14px]'}>Đăng ký ngay</span>
                    </button>
                </div>
                <div className={'store-wrapper  mt-[20px] flex flex-col gap-y-[30px]'}>
                    <div className={'title text-primary font-[600] text-[22px]'}>
                        Ứng dụng Phuc Khang Gems
                    </div>
                    <div className={'flex gap-x-[20.82px]'}>
                        <Image src={GooglePlay} alt={'phuc-khang-gems-google-play'} width={144.59} height={55.52}/>
                        <Image src={AppleStore} alt={'phuc-khang-gems-apple-store'} width={144.59} height={55.52}/>
                    </div>
                </div>
                ...
                <div className={'line border-b-[2px] border-[#DEDFE0] my-[10px]'}></div>
                <div className={'context-with-us text-subText flex flex-col gap-y-[20px]'}>
                    ...
                    <div className="icons-wrapper flex gap-[20px] flex-wrap max-w-[208px] justify-start">
                        <div
